...
async function main() {
    ...
    const [robertMartin, martinFowler, erichGamma, richardHelm, ralphJohnson, johnVlissides, kentBeck, joshuaBloch,] = authors;
    ...
    const [cleanCode, pragmatic, refactoring, cleanArch, designPatternsBook] = books;
